...
export const FCTPauseButton = ({ id, state, pauseIcon, playIcon }: PauseButtonType) => {
  ...
  const unblockUserDeniedError = (unblockIsError as any)?.reason === userDeniedMsg
  ...
  }, [block, blockIsDone, blockIsFailed, blockUserDeniedError, toast])
  ...
  }, [toast, unblock, unblockIsDone, unblockIsFailed, unblockUserDeniedError])
  ...
  if (state === 'blocked') {
    return <PauseButton title="Regular Pause" description="On chain pause, paid gas" leftIcon={pauseIcon} isDisabled />
  }
  if (state === 'disabled') {
    return <PauseButton title="Regular Pause" description="On chain pause, paid gas" leftIcon={pauseIcon} isDisabled />
  }
